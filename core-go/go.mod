module github.com/karurosux/saas-go-kit/core-go
...
require (
	...
	github.com/karurosux/saas-go-kit/ratelimit-go v0.0.0
)
...
replace (
	...
	github.com/karurosux/saas-go-kit/ratelimit-go => ../ratelimit-go
)